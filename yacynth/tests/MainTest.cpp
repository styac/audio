 ...
 * Author: ist
 *
 * Created on February 28, 2017, 10:19 PM
 */
#include    "../src/utils/Biquad.h"
#include    "../src/utils/BiquadMath.h"
#include    "../src/utils/Limiters.h"
#include    "../src/utils/GaloisNoiser.h"
#include    "../src/utils/FilterBase.h"
#include    "../src/oscillator/Tables.h"
#include    "../src/oscillator/Oscillator.h"
#include    "../src/oscillator/OscillatorArray.h"
#include    "../src/oscillator/ToneShaper.h"
#include    "../src/yaio/YaIoJack.h"
#include    "../src/yaio/IOthread.h"
#include    "../src/net/Server.h"
#include    "../src/router/SimpleMidiRouter.h"
#include    "../src/effects/Filter.h"
#include    "../src/effects/DelayTap.h"
#include    "../src/effects/FxFilter.h"
#include    "../src/effects/FxOutNoise.h"
#include    "../src/effects/FxModulator.h"
#include    "../src/effects/FxOutOscillator.h"

#include    "../src/control/Controllers.h"
#include    "../src/control/Sysman.h"
#include    "../src/control/SynthFrontend.h"
...
#define BOOST_TEST_MODULE yactest
...
BOOST_AUTO_TEST_CASE(FilterTableExp2Pi)
{
    float freq = 10.0;
    float df = 1.059;
...
//       const float exa = FilterTableSinCosPi2::getInstance().fc_sinpercosPi2_F( freq/48000.0 );
 ...
 //       const float intp = FilterTableCos2Pi::getInstance().getFloat( ycent );
 //       const float exa = FilterTableCos2Pi::getInstance().fc_cosPi2_F( freq/48000.0 );

//        const float intp = FilterTableExp2Pi::getInstance().getFloat( ycent );
//        const float exa = FilterTableExp2Pi::getInstance().fc_expPi2_F( freq/48000.0 );
...
BOOST_AUTO_TEST_CASE(GaloisShifter)
{
...
BOOST_AUTO_TEST_SUITE_END()
        ...
        #if 0
    FilterBaseOld::Ftable2SinPi tablesi;
        std::cout
            << " ======================================  "
            << std::endl;
        ...
        for( auto octave = 29; octave < 30; ++octave ) {
            for( auto inOctave = 0; inOctave < 4096; ++inOctave ) {
                ...
                const float     fc =  FilterBaseOld::logF_fc(valf ) ;
...
#endif
#if 0
    FilterBaseOld::FtableSinCosPi2 tablesc;
...
exit(0);
    ...
    FilterBaseOld::FtableExp2Pi table;
