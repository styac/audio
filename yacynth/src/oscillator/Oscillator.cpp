...
GaloisShifter           Oscillator::gRandom;    // obsolate
...
//++++++++++++++++++++++++++++
            ...
            if( envelopeKnotRelease == stateOsc.envelopePhase ) { // release
                ...
                if( 0 == stateOsc.tickFrame ) { // if fastRelease then stateOsc.tickFrame == 1
                    stateOsc.tickFrame = toneshaper.tickFrameReleaseLF;
                ...
                while( 0 == stateOsc.tickFrame ) {
                    changeEnvPhase = true;
                    stateOsc.tickFrame = toneshaper.transient[stateOsc.envelopePhase].tickFrameLF;
...
//++++++++++++++++++++++++++++
                ...
                if( changeEnvPhase ) {
                    ...
                    stateOsc.envelopeTargetValueVelocity =
                        (velocity * static_cast<uint64_t>(currentEnvelopeKnot.targetValueLF)) >> 10; // 25 bit for the signal
