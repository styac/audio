...
namespace Tuning {
    ...
    TuningGenerator12Notes  table_TM_21_Werckmeister3 ( 
        2.0, 1.0, 12,   
        {
            0.0,                    // 00 - C
    ...
    TuningGenerator12Notes  table_TM_21_Young2 ( 
        2.0, 1.0, 12,   
        {
            0.0,                    // 00 - C
            93.9    * cent2ycent,   // 01
    ...
    TuningGenerator12Notes  table_TM_21_Pythagorean ( 
        2.0, 1.0, 12,   
        {
    ...
    TuningGenerator12Notes  table_TM_21_Ptolemy ( 
        2.0, 1.0, 12,   
        {
            interval2ycent(          1.0 ),    // 00 - C
    ...
    TuningGenerator43Notes  table_TM_21_Partch43 ( 
        2.0, 1.0, 43,   
        {
// ===========
            interval2ycent(          1.0 ),    // 00 - C
